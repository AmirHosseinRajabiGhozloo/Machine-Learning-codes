# -*- coding: utf-8 -*-
"""U_Net_Cancer_Segmentation.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1RzUW1wBQI6wiVkP9FkS-GYnLrQGznim1
"""
...
TRAIN_IMAGE_PATH = 'gdrive/My Drive/U_Net_Medical_Data/Inputs_Train'
TRAIN_MASK_PATH = 'gdrive/My Drive/U_Net_Medical_Data/Masks_Train'
TEST_IMAGE_PATH = 'gdrive/My Drive/U_Net_Medical_Data/Inputs_Test'
TEST_MASK_PATH = 'gdrive/My Drive/U_Net_Medical_Data/Masks_Test'
...
def U_Net_Segmentation(input_size=(IMG_HEIGHT, IMG_WIDTH, IMG_CHANNELS)):
    ...
    model.compile(optimizer='adam', loss=tf.keras.losses.MeanSquaredLogarithmicError(), metrics=[numpy_mean_iou])
    model.summary()
    return model
